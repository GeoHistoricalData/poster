...
%      \text{Paris : base de données spatio-temporelle / geocodage automatisé }\\
  ...
  \begin{columns}
    ...
    \begin{minipage}[t]{.98\textwidth}
	  ...
	  \centering\includegraphics[width=0.76\textwidth]{figures/cassini} \\
          \scriptsize
      ...
      \begin{block}{Spatial \& Morphological Analysis}
        \centering
	\begin{tabular}{>{\centering}m{0.99\textwidth}}
	  \includegraphics[width=0.4\textwidth,trim={3.5cm 1.55cm 4cm 3.2cm},clip]{figures/EvolutionPatterns}\\
