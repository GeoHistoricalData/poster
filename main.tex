...
\newcommand{\important}[1]{\textbf{\textcolor{ta4orange}{#1}}}
\newcommand{\lessimportant}[1]{\textbf{\textcolor{ta3skyblue}{#1}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
...
\centering
  \begin{block}{What is the GeoHistoricalData Project?}
    \important{GeoHistoricalData} (GHD) is a long-term \textbf{collaborative research project} involving researchers from several institutions.\\% {\scriptsize(\textit{CRH/EHESS-CNRS, LaSTIG/IGN, CEA, CHARTA SRL, IFSTTAR, ArScAn, Le Ny Conseil, Géographie Cités/Sorbonne, INRA Nancy, Archives Nationales, LRDE/EPITA, etc.})}.\\
    In addition to a \textbf{methodological roadmap for the construction of geo-historical information}, we promote joint research in collaboration with other research groups focused on specific territories and time periods.% The Parisian part of the project has been recently founded by ANR (SoDUCo - \textit{Social Dynamics in Urban COntext. Open tools, models, and data - Paris and its suburbs, 1789-1950}. 2019-2023).
    ...
    \begin{itemize}
    \item \lessimportant{Metropolitan France:} \important{Cassini} map thematic vectorisation (roads, churches, etc.)
    \item \lessimportant{Auvergne:} \important{reconstruction of Cassini sheet n\degree52} with the University of Clermont-Ferrand
    ...
    \item \lessimportant{Paris:} spatio-temporal databases and geocoding, including \important{St Jean de Latran}{\scriptsize ~\cite{Rebolledo-Dhuin2014}}
...
%    \renewcommand{\footnoterule}{}
    \begin{block}{Primary Sources and Georeferencing}
      ...
      \begin{tabular}{p{0.49\textwidth}p{0.49\textwidth}}
        \multicolumn{2}{p{0.98\textwidth}}{Beyond \textbf{georeferencing} and \textbf{digitizing} maps, we propose a \textbf{thorough analysis} of these maps, including their planimetric accuracy{\scriptsize ~\cite{Dumenieu2013a,Dumenieu2015PhD}}}\\
        \multicolumn{2}{c}{
  	\centering\includegraphics[width=0.9\textwidth,trim={0 0 0 8cm},clip]{figures/plans}
        }\\
    ...
    Atlas du plan général de la ville de Paris, levé géométriquement par le cen \textsc{•}niquet} rapporté sur une échelle d'une demie ligne pour toise, divisée en 72 planches, compris les cartouches et plan des opérations trigonométriques.}\href{http://catalogue.bnf.fr/ark:/12148/cb31564124v};
        ...
        \multicolumn{2}{p{0.98\textwidth}}{\centering Measuring the planimetric accuracy of the Verniquet's atlas of Paris{\scriptsize ~\cite{Dumenieu2018}}}\\	
    ...
    \begin{block}{Large Historical Geocoding}
      ...
      \begin{tabular}{>{\centering}m{0.98\textwidth}}
        \includegraphics[width=0.935\textwidth,trim={0 6cm 0 2cm},clip]{figures/geocoding}\\
...
%    \begin{minipage}[t]{.98\textwidth}
      \begin{block}{Collaborative Content Extraction}
        \centering
        \begin{flushleft}
          Topography, natural graphs, historical networks \textit{\&} forests{\scriptsize ~\cite{Perret2015_,Perret2015Data_,vallauri2012forets}}
        \end{flushleft}
        \begin{tabular}{p{0.98\textwidth}}
	  \centering\includegraphics[width=0.98\textwidth]{figures/cassini} \\
          \scriptsize
          On the left: Collaborative digitization of the Complete set of \textbf{Cassini \textsc{iii}'s map of France} in 180 sheets, 1750-1790.
...
%    \begin{minipage}[t]{.98\textwidth}
      \begin{block}{Main contributions}%Conclusion \& Applications}
        ...
        \begin{itemize}
        \item a \important{global approach} to study the \textbf{co-evolution of spatial and social dynamics}{\scriptsize ~\cite{Dumenieu2013a, Dumenieu2015PhD}}
        \item a \important{critical analysis} of \important{primary sources}{\scriptsize ~\cite{Costes2015_, Dumenieu2015PhD, Costes2016PhD, Dumenieu2018}}
        \item the \important{collaborative co-construction} of geo-historical information{\scriptsize ~\cite{Perret2015_, Perret2015Data_, Cura2018}}
        \end{itemize}
      \end{block}
%    \end{minipage}
%    \end{beamercolorbox}
...
%        \begin{minipage}[t]{.98\textwidth}
    ...
    \vspace*{-0.25em}
            ...
            \item[\important{Group:}] \url{https://github.com/GeoHistoricalData}\\
            \item[\important{Geocoder:}] \url{https://github.com/GeoHistoricalData/historical_geocoding}\\
            %\item[\textcolor{ta4orange}{Arpenteur Topographe:}] \url{http://geohistoricaldata.herokuapp.com/}\\
            \item[\important{Datasets:}]
              ...
              \end{itemize}
            \item[\important{Semantic Wiki:}] \url{http://wiki.geohistoricaldata.org/}
            \end{Mdescription}
          \end{block}
%        \end{minipage}
%      \end{beamercolorbox}
