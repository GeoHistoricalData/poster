  ...
  \begin{columns}
    ...
    \begin{block}{Primary Sources and Georeferencing}
      ...
      \begin{tabular}{p{0.49\textwidth}p{0.49\textwidth}}
        ...
        \multicolumn{2}{c}{\includegraphics[width=0.8\textwidth,trim={0 3.2cm 0 2cm},clip]{figures/plans_V2.png}}\\
    ...
    \begin{minipage}[t]{.98\textwidth}
	  ...
	  \centering\includegraphics[width=0.96\textwidth]{figures/cassini} \\
          \scriptsize
